        ...
        new Add([
          ...
          new Minus([
            new Divide([
              new Mul([
                new Name("RT"),
                new Ln(new Divide([new Name("K_stroma"), new Name("K_lumen")])),
              ]),
      ...
      fn: new Mul([
        ...
        new Add([
          ...
          new Divide([
            new Mul([
              new Name("RT"),
              new Ln(new Divide([new Name("Cl_stroma"), new Name("Cl_lumen")])),
            ]),
            new Mul([new Name("F"), new Ln(new Num(10.0))]),
          ]),
        ]),
          ...
          new Add([
            ...
            new Exp(
              new Add([
                ...
                new Minus([new Mul([new Num(1000.0), new Name("delta_psi")])]),
              ]),
            ),
          ]),
        ]),
      ...
      fn: new Divide([
        ...
        new Mul([
          ...
          new Add([
            ...
            new Exp(
              new Add([
                new Mul([new Num(1000.0), new Name("VCCN_delta_psi_treshold")]),
                new Minus([new Mul([new Num(1000.0), new Name("delta_psi")])]),
              ]),
            ),
          ]),
    ...
    .addReaction("Cl_leak", {
      fn: new Divide([
        new Mul([
          ...
          new Name("k_Cl_leak"),
          new Pow(
            new Add([new Name("Cl_lumen"), new Minus([new Name("Cl_stroma")])]),
            new Num(2.0),
          ),
        ]),
        new Mul([
