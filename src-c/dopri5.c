/* dopri5.f -- translated by f2c (version 20200916).
	...
	integer *idid)
{
    ...
    integer iek1, iek2, iek3, iek4, iek5, iek6, iey1;
    doublereal beta, safe;
    integer ieco, nfcn, meth;
    doublereal hmax;
    integer nmax, ieys, icomp;
    logical arret;
    integer nstep, naccpt, nrejct;
    ...
    integer nstiff, nrdens, iprint, istore;
    doublereal uround;
	...
	*nstep, integer *naccpt, integer *nrejct)
{
    ...
    /* Local variables */
    integer i__, j;
    doublereal c2, c3, c4, c5, e1, e3, e4, e5, e6, e7, d1, d3, d4, d5, d6, d7,
	     a21, a31, a32, a41, a42, a43, a51, a52, a53, a54, a61, a62, a63, 
	    a64, a65, a71, a73, a74, a75, a76, sk, yd0, fac, err, xph, fac11;
    integer iord;
    logical last;
    ...
    doublereal stden, rtoli;
    integer irtrn;
    doublereal stnum, facold;
    logical reject;
	...
	doublereal *rtol, integer *itol, doublereal *rpar, integer *ipar)
{
    ...
    doublereal h__;
    integer i__;
    doublereal h1, sk, dnf, dny, der2, der12, atoli, rtoli;
